...
export function App() {
  ...
  return <div className="shell">
    <header className="topbar"><a className="logo" href="#"><img src="/tempus-mark.png" alt="Tempus"/><span>tempus</span><span className="product">signal</span></a><div className="source-status"><i/> Live public data <b>•</b> NPPES + ClinicalTrials.gov</div><div className="account"><span>John Doe<small>Territory manager</small></span><button className="user">JD</button></div></header>
    <main>
