...
function ProviderAvatar({provider,photo}:{provider:Provider;photo?:ProviderPhoto}){return photo?<span className="doctor-photo" title="Photo matched by exact NPI via Wikidata"><img src={photo.url} alt={name(provider)}/></span>:<span className="doctor-photo fallback" title="No NPI-linked public photo exists">{provider.basic.first_name?.[0]}{provider.basic.last_name?.[0]}</span>}
